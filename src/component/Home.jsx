...
const Home = () => {
  return (
    <div name="home" className="bg-[#F6F5F5] w-full h-screen">
      {/* container */}
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center  h-full ">
        ...
        <div>
          <button className="text-[#276678] group border-2 border-[#276678] px-6 py-3 my-2 flex items-center hover:bg-[#1687A7] hover:text-white">
            View Works
